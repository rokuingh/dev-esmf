...
grid_dst = ESMF.Grid(filename="tasmax_day_CanCM4_decadal2010_r2i1p1_20110101-20201231.nc", 
                    filetype=ESMF.FileFormat.GRIDSPEC, add_corner_stagger=True)
...
print numpy.sum(numpy.abs(field_dst.data/dstfracfield.data-field_exact.data)/numpy.abs(field_exact.data))
