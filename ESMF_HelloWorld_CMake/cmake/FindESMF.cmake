...
string(REPLACE " " ";" COMPILEOPTS "${ESMF_F90COMPILEPATHS} ${ESMF_F90COMPILEFREECPP} ${ESMF_F90COMPILECPPFLAGS}")

# Fortran specific compile opts
string(REPLACE " " ";" COMPILEOPTSF90 "${ESMF_F90COMPILEOPTS} ${COMPILEOPTS}")
...
target_compile_options(ESMF INTERFACE
          $<$<COMPILE_LANGUAGE:Fortran>:${COMPILEOPTSF90}>
          $<$<COMPILE_LANGUAGE:CXX>:${COMPILEOPTS}>
          $<$<COMPILE_LANGUAGE:C>:${COMPILEOPTS}>
          )