...
! 
! NOTE: This demo does not work in parallel if either the 'real_data' or 
! 'read_weights_from_file' macros are enabled.  Parallel mode is enabled by
! defining the 'parallel' macro.
!===============================================================================
