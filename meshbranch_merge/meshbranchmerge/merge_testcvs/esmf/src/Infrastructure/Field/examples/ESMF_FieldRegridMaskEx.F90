...
! (specified by the {\tt maxHaloWidth} arguments in {\tt FieldCreate}) and the size of the tensor
...
! {\tt maxHaloWidth} arguments to include this extra padding in the Field. Note, however, 
