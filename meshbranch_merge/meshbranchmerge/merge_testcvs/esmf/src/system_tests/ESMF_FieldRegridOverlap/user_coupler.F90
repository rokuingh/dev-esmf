...
!   ! Initialization routine.
    ...
    subroutine user_init(comp, importState, exportState, clock, rc)
      ...
      type(ESMF_VM) :: vm
      integer :: lDEC, localPet, petCount
...
#if 0
      ! Write out info about local DE count
      call ESMF_VMGEt(vm,localPet=localPet, petCOunt=petCount)

      call ESMF_FieldGet(humidity1, localDECount=lDEC)   
      write(*,*) "SRC ",localPet," out of ",petCount," localDECount=",lDEC

      call ESMF_FieldGet(humidity2, localDECount=lDEC)   
      write(*,*) "DST ",localPet," out of ",petCount," localDECount=",lDEC
#endif
