...
public:
  ...
  UInt dim(const MeshObj &obj) { return a.dim(obj); }
...
struct OwnerAction {
  ...
  UInt dim(const MeshObj &) { return 1; }
...
public:
  ...
  UInt dim(const MeshObj &obj) const { return field.dim(obj);}
