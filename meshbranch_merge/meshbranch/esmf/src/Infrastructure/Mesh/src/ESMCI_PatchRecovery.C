...
=======
// $Id: ESMCI_PatchRecovery.C,v 1.8 2010/03/04 18:57:45 svasquez Exp $
//
...
static const char *const version = "$Id: ESMCI_PatchRecovery.C,v 1.8 2010/03/04 18:57:45 svasquez Exp $";
//-----------------------------------------------------------------------------
...
#else
  Throw() << "Please recompile with ESMCI_LAPACK enabled";
#endif
